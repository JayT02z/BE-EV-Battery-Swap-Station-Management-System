...
import com.boilerplate.auth.enums.tickets.SupportTicketType;
import com.boilerplate.auth.enums.tickets.TicketPriority;
...
public class SupportTicketController {
    ...
    public ResponseEntity<ResponseData<CreateSupportTicketResponse>> createSupportTicket(
        ...
        SupportTicketType ticketTypeEnum;
        TicketPriority priorityEnum;

        try {
            ticketTypeEnum = SupportTicketType.valueOf(ticketType);
