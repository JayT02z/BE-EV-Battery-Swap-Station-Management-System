...
import com.boilerplate.billing.client.service.auth_user_service.model.admin.AuthUserServiceClient;
import com.boilerplate.billing.clients.BookingClient;
...
public class PaymentService {
    ...
    @Autowired
    private AuthUserServiceClient authUserClient;
    ...
    public ResponseEntity<ResponseData<PackagePaymentDTO>> createPackagePayment(PackagePaymentRequest request) {
        ...
        ResponseData<com.boilerplate.billing.client.service.auth_user_service.model.admin.response.UserResponse> response =
                authUserClient.getDriverByEmployeeId(request.getCustomerId());
        ...
        com.boilerplate.billing.client.service.auth_user_service.model.admin.response.UserResponse userResponse = response.getData();

        // 2. Kiểm tra xem driver đã có trong DB chưa
        Driver driver = driverRepository.findByEmployeeId(userResponse.getEmployeeId()).orElse(null);
        ...
        // 4. Map từ UserResponse sang Entity
